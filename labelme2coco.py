...
if __name__ == '__main__':
    ...
    #   labelme标注数据保存的位置
    #------------------------------------#
    input_dir       = "datasets/png"
    #------------------------------------#
    #   输出的图片文件保存的位置
    #------------------------------------#
    Img_output_dir  = "datasets/coco1/JPEGImages"
    #------------------------------------#
    #   输出的json文件保存的位置
    #------------------------------------#
    Json_output_dir = "datasets/coco1/Jsons"
    #--------------------------------------------------------------------------------------------------------------------------------#
    ...
    for label_files_index, label_files in enumerate(label_files_list):
        ...
        for image_id, label_file in enumerate(label_files):
            ...
            out_img_file    = osp.join(Img_output_dir, base + '.png')
            ...
            for shape in label_data['shapes']:
                ...
                mask        = labelme2coco.utils.shape_to_mask(img.shape[:2], points, shape_type)
